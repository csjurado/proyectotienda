...
@section('title', 'Tienda | Registrar')
@section('content')
    <!-- Start All Title Box -->
                    ...
                    <div class="Account-address">
                        <div class="title-left">
                            @if (Session::has('status'))
                                <div class="alter alert-success"> {{ Session::get('status') }}</div>
                            @endif
                            @if (count($errors) > 0)
                            ...
                            @endif
                            <h3>Registrar | ¿Tienes una cuenta? <a href="{{ route('cliente.inicarsesion') }}"> Iniciar
                                    Sesión</a> </h3>
                        </div>
                        <form action="{{ route('crearcuenta') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-12">
                                    <input type="submit" value="Registrar" class="btn btn-default hvr-hover btn-cart w-100">
                                </div>
                            </div>
                            <hr class="mb-1">
                        </form>
