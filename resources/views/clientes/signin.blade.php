...
@section('title', 'Tienda | Iniciar Sesión')
@section('content')
    <!-- Start All Title Box -->
            ...
            <div class="row new-account-login">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <form class="mt-3 collapse review-form-box" id="formRegister">
                        ...
                        <button type="submit" class="btn hvr-hover">Iniciar Sesión</button>
                    </form>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="Account-address">
                        <div class="title-left">
                            @if (Session::has('error'))
                                <div class="alter alert-danger"> {{ Session::get('error') }}</div>
                            @endif
                            @if (count($errors) > 0)
                            ...
                            @endif
                            <h3>Iniciar Sesión | ¿No tienes una cuenta? <a href="{{ route('cliente.registrar') }}">
                                    Registrar</a> </h3>
                        </div>
                        <form action="{{ route('accedercuenta') }}" method="POST">
                            @csrf
                            <div class="mb-3">
