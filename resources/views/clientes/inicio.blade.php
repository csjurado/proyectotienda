            ...
            @foreach ($sliders as $slider)
                <li class="text-center">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>Bienvenido a <br> CarlosTienda</strong></h1>
                                <p class="m-b-40">{{ $slider->descripcion1 }} <br>
                                    {{ $slider->descripcion2 }}</p>
                                <p><a class="btn hvr-hover" href="#">Compra Algo Nuevo</a></p>
                            </div>
                        </div>
                    </div>
                </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        ...
                        <p>Estos son los productos más novedosos de esta semana</p>
                    </div>
                </div>
            </div>
            <!-- <div class="row">
                        ...
                        <div class="products-single fix">
                            <div class="box-img-hover">
                                ...
                                <div class="mask-icon">
                                    ...
                                    <a class="cart" href="{{ route('cliente.añadiralcarrito',[$producto->id]) }}">Añadir al Carrito</a>
                                </div>
                            </div>
                            <div class="why-text">
                                <h4>{{ $producto->producto_nombre }}</h4>
                                <h5> $ {{ $producto->producto_precio }}</h5>
                            </div>
                        </div>
                    </div>
                @endforeach
