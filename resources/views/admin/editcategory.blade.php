                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Editar Categoría</small></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            ...
                            <form action="{{ route('actualizarcategoria', $categoria->id) }}" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  name="categoria_nombre" value="{{ $categoria->categoria_nombre }}"
                                            class="form-control" id="exampleInputEmail1" placeholder="Snacks">
